	...
	KeyboardPanel {
		...
		PanelKeyCatcher {
			...
			Column {
				...
				Text {
					width: parent.width
					text: logic.count + "  (step " + logic.step + ")"
				...
				Row {
					...
					Button { text: "-"; onClicked: logic.dec() }
					Button { text: "+"; onClicked: logic.inc() }
					Button { text: "Reset"; onClicked: logic.reset() }
				}

				Text {
					width: parent.width
					text: "Edit src/index.js to change the shared core,\nthen run \"oma build\" and \"oma install\"."
